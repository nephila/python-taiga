...
latex_documents = [
    (master_doc, "python-taiga.tex", "python-taiga Documentation", "Nephila", "manual"),
]
...
man_pages = [(master_doc, "python-taiga", "python-taiga Documentation", [author], 1)]
